...
\DeclareCaptionType{snippet}[Snippet][List of Code Snippets]
...
\supervisor{Dr. Salimur Choudhury}
...
\begin{acknowledgements}
	Dr. Mike Biocchi for being my faculty peer-reviewer.
...
\include{chap1} % drafted % introduction
\include{chap2} % drafted % web threats
\include{chap3} % drafted % detection methods
\include{chap4} % drafted % machine learning
\include{chap5} % drafted % methods
\include{chap6} % drafted % results
\include{chap7} % drafted % discussion
\include{chap8} % drafted % conclusion
\include{appendices}
